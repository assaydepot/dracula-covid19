...
pub fn remap_territories(record: &mut CovidRecord) {
    let new_country_region = match record.province_state.as_deref() {
        ...
        Some("Reunion") => Some("France - Reunion"),
        Some("Montserrat") => Some("United Kingdom - Montserrat"),
        ...
        Some("Faroe Islands") => Some("Denmark - Faroe Islands"),
        Some("Greenland") => Some("Denmark - Greenland"),
        _ => None,
    };
